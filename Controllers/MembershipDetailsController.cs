...
namespace FitHub.Controllers
{
    ...
    {
        private readonly MembDetailDBContext _context;

        public MembershipDetailsController(MembDetailDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.MembershipDetail != null ?
                        ...
                        Problem("Entity set 'MembDetailDBContext.MembershipDetail'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'MembDetailDBContext.MembershipDetail'  is null.");
            }
            var membershipDetail = await _context.MembershipDetail.FindAsync(id);
            if (membershipDetail != null)
            {
